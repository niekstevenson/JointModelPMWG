...
source("pmwg/utils_factors.R")
source("pmwg/messaging.R")

pmwgs <- function(data, pars, ll_func, n_factors, prior = NULL, constraintMat = NULL) {
...
gibbs_step_factor <- function(sampler){
  ...
  #This is included for later steps when including non 1's on the diagonals, you need to translate your lambda's
  lambda_orig <- lambda
