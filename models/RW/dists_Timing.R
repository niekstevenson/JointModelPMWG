  ...
  # density for single accumulator
{
  digt <- function(t,k=1,l=1,a=.1,s=1,tiny=1e-10) {
    ...
    digt.0 <- function(t,k=1,l=1, s=1) {
      ...
      # much faster than statmod's dinvgauss function
...
n1WaldTiming_NS <- function(dt,B,A,t0, B_T, v_T, s_T, A_T, t0T, p.guess = (1/3), gf=0, ...)
...
dWaldRaceTiming <- function(rt, response, A, B, t0, B_T, v_T, s_T, A_T, t0T, ..., 
